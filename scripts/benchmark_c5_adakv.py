...
def generate_prepared_c5(
    ...
    *,
    ...
    """Generate with C5 from finalized IDs, preserving its cache behavior."""
    ...
    past, last_logits, stats = _prefill_and_compress(
        ...
        window=ADA_WINDOW_SIZE,
        kernel=ADA_KERNEL_SIZE,
        device=device,
    )
...
def _generate_ada(
    ...
    prediction, _, stats = generate_prepared_c5(
        model,
        tokenizer,
        ids,
        max_new,
